// ClearGem v1.0.8 — MAIN World Image Processor
...
(function () {
    ...
    function findNearestGeminiImage(el) {
        ...
        const containers = ['.generated-image-container', '[data-generation-id]', 'generated-image'];
        ...
        for (let i = 0; i < 10 && node; i++) {
            ...
            if (img && (isGeminiImageUrl(img.src) || img.src.startsWith('blob:'))) {
                return img;
            }
    ...
    document.addEventListener('click', async (e) => {
        ...
        if (isDownloadButton(e.target)) {
            ...
            try {
                const blob = await getCleanBlob(img);
                if (blob) {
    ...
    init();
    console.log('[ClearGem] v1.0.8 interceptor loaded');
})();
